...
test('Pressure Test - 50 Questions (General User)', async ({ page }) => {
  ...
  await page.screenshot({ path: 'pressure_test_50_result.png', fullPage: true });
  console.log('SUCCESS: 50-Question Pressure Test Verified.');
});
